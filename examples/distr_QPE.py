...
family = qraise(2,"00:10:00", simulator="Cunqa", classical_comm=True, mode="cloud", family_name="for_distr_QPE")
os.system('sleep 5')
qpus_QPE  = getQPUs(family)

# Define the circuits to be run 
circ_QPE_1 =CunqaCircuit(1, id="first")

circ_QPE_2 =CunqaCircuit(1, id="second")
