module load cesga/2022 gcc/system openmpi/4.1.4 scalapack/2.2.0 openblas/system openblas/0.3.25
...
g++ -std=c++17 example.cpp -o example -I$AER_INCL_DIR -I$PYBIND_INCL_DIR -I$PYTHON_INCL_DIR -L$PYTHON_LIB -fopenmp -llapack -lblas -fPIC -lpython3.9