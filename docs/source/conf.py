...
extensions = ['sphinx.ext.githubpages',  'sphinx.ext.doctest', 'sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx.ext.sphinx_mdinclude', 'nbsphinx', 'sphinx_gallery.load_style',]
