...
extensions = ['sphinx.ext.githubpages',  'sphinx.ext.doctest', 'sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'myst_parser',] # 'myst_nb', 'sphinx_mdinclude', this ones were troublesome
