...
extensions = ['sphinx.ext.githubpages',  'sphinx.ext.doctest', 'sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx_mdinclude',] # 'myst_parser', 'sphinx_mdinclude', this ones were troublesome
